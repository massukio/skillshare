...
const ALL_STEPS: TourStep[] = [
  ...
  { id: 'install-form', page: '/install', targetSelector: "[data-tour='install-form']", title: 'Install Resources', description: 'Enter a git repo URL or local path to install skills or agents. Track mode (--track) enables future updates.', placement: 'bottom' },
